...
private:
    ...
    float calcVelocity; //Расчетная скорость локомотива v_р
...
public:
    Locomotive(QString *type, int mass, int constructionVelocity, float calcVelocity);
